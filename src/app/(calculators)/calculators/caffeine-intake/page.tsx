...
import IntakeCalculator from '@/components/features/loaders/IntakeCalculatorLoader';
import {
  Accordion,
  AccordionContent,
  AccordionItem,
  ...
  "breadcrumb": {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://calculation.site/calculators/caffeine-intake"
      }
    ]
  },
  "howTo": {
          ...
          <Separator />
            ...
            <section id="how-it-works" aria-labelledby="how-it-works-heading">
                ...
                <Card className="my-8 bg-primary/5 border-primary/20">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2"><Lightbulb className="text-primary" aria-hidden="true" />Caffeine Smart Tip</CardTitle>
                    </CardHeader>
                    <CardContent>
                    ...
                    <TableBody>
                        ...
                        <TableRow>
                         ...
                         <TableRow>
                            ...
                            <TableCell>Allows you to add your own items if they aren't in our database, such as local coffee shop blends or supplements.</TableCell>
