        ...
        <div className="prose prose-lg dark:prose-invert max-w-none mx-auto space-y-12">
          ...
          <Separator />
           ...
           <section id="worked-examples" aria-labelledby="worked-examples-heading">
                ...
                <Card className="mb-6">
                    <CardHeader><CardTitle>The Morning Latte Drinker</CardTitle></CardHeader>
                    <CardContent>
                 ...
                 <Card className="mb-6">
                    <CardHeader><CardTitle>The European Tourist</CardTitle></CardHeader>
                    <CardContent>
                ...
                <Card>
                    <CardHeader><CardTitle>The Student with an Iced Americano</CardTitle></CardHeader>
                    <CardContent>
