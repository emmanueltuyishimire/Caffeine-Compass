          ...
          <div className="lg:col-span-1 prose prose-lg dark:prose-invert max-w-none space-y-12">
            ...
            <Separator />
             ...
             <section id="use-cases" aria-labelledby="use-cases-heading">
                ...
                <p>Want an afternoon pick-me-up that won't ruin your sleep? Use the database to find low-caffeine options. You could filter by "Tea" and sort from low to high to discover that a Green Tea (28mg) is a much safer choice than a Black Tea (47mg). This knowledge is crucial when planning your "caffeine curfew" with the <Link href="/calculators/caffeine-half-life">Half-Life Calculator</Link>.</p>
