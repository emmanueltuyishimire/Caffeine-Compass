            ...
            <div className="lg:col-span-1 prose prose-lg dark:prose-invert max-w-none space-y-12">
                ...
                <Table>
                    ...
                    <TableBody>
                        ...
                        <TableRow>
                            <TableCell className="font-medium">Half-Life Selection</TableCell>
                            <TableCell>Allows you to choose a half-life in hours that reflects your sensitivity.</TableCell>
                ...
                <section id="how-to-use" aria-labelledby="how-to-use-heading">
                    ...
                    <ol className="list-decimal pl-5 space-y-4">
                        ...
                        <li>
                            <strong>Step 2: Select Your Half-Life</strong><br/>
