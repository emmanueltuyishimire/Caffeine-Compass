      ...
      <div className="prose prose-lg dark:prose-invert max-w-none mx-auto mt-20 space-y-12">
        ...
        <section id="how-it-works">
            ...
            <p>Any dose approaching this level is a dire medical emergency.</p>
             ...
             <Card className="my-8">
                <CardHeader>
                    <CardTitle className="flex items-center gap-2"><BookOpen className="text-accent"/>Scientific Reference</CardTitle>
                </CardHeader>
                <CardContent>
                    <p className="text-lg">
        ...
        <section id="examples">
            ...
            <Card className="mb-6">
                <CardHeader>
                    <CardTitle className="flex items-center gap-3"><BrainCircuit /> The Student and Energy Drinks</CardTitle>
                </CardHeader>
            ...
            <Card className="mb-6">
                <CardHeader>
                    <CardTitle className="flex items-center gap-3"><Activity /> The Gym-Goer and Pre-Workout Powder</CardTitle>
                </CardHeader>
                <CardContent className="space-y-2">
