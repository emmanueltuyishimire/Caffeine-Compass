      ...
      <CardContent className="space-y-6">
        <div className="flex flex-col sm:flex-row gap-2">
           <div>
            ...
            <Button id="drink-search" variant="outline" onClick={() => setOpen(true)} className="w-full sm:w-[300px] justify-between" aria-haspopup="dialog" aria-label="Search for a drink to add">
           ...
           <Button onClick={() => setConsumed([])} variant="secondary" aria-label="Reset daily log">Reset Day</Button>
        </div>
        ...
        <div className="p-4 border rounded-lg bg-muted/50 space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2" aria-labelledby="custom-item-heading">
                ...
                <Button onClick={addCustomDrink} disabled={!customName || !customCaffeine} aria-label="Add custom item">
