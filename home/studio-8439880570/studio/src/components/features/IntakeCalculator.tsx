      ...
      <CardContent className="space-y-6">
        <div className="flex flex-col sm:flex-row gap-2">
          <div>
            ...
            <Button id="drink-search" aria-label="Search for a drink" variant="outline" onClick={() => setOpen(true)} className="w-full sm:w-[300px] justify-between">
                Search for a drink...
           ...
           <Button onClick={() => setConsumed([])} variant="secondary" aria-label="Reset daily intake">Reset</Button>
        </div>
        ...
        <div className="p-4 border rounded-lg bg-muted/50 space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2" aria-labelledby="custom-drink-heading">
                ...
                <Button onClick={addCustomDrink} disabled={!customName || !customCaffeine} aria-label="Add custom drink">
